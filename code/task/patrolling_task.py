...
task = Formula_task_GF(op_out='G', 
                     op_in=['F','F'], 
                     T=T, tau=[tau, tau], target=region[0:2,:])
...
# options['replay_period'] = 1


if args.suffix == '0905a':
    print('>>> 0905a:')
    options['MAX_EPISODE'] = 10000
    options['CHECK_INTERVAL'] = 50
    options['EPS'] = [0.99, 0.01, 1000]
    options['LR'] = [0.01, 0.01, 300]
    options['buffer_size'] = 10000 # size of the experience pool
